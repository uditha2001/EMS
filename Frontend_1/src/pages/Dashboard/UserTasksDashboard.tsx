...
// Define types for the role assignment data
...
const UserTasksDashboard = () => {
  ...
  // Function to determine the status and color based on due date
  ...
  // Function to get days remaining message
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between mb-4 px-1">
            <div>
              ...
              <p className="text-xl font-semibold text-gray-800 dark:text-white">{assignments.length}</p>
            </div>
            <div>
          ...
          {sortedAssignments.map((assignment) => {
            const { status, color, textColor, borderColor, icon: StatusIcon, iconColor } = getTaskStatus(
              assignment.grantAt,
            );
            return (
              <div
                ...
                <div className="p-4">
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex items-center">
                      ...
                      <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${color} ${textColor}`}>
                        {status}
                      </span>
                    </div>
