...
const SecondMarking = () => {
    ...
    return (
        <div className="mx-auto max-w-full">
            ...
            <div className=" dark:from-gray-900 dark:to-gray-800 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark max-w-full mx-auto">
                                                ...
                                                <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                                    {filterData.map((row: any, rowIndex: any) => (
                                                        <tr key={rowIndex} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                                            ...
                                                            <td className={`px-3 py-2 sm:px-6 sm:py-4 text-xs sm:text-sm text-gray-700 border-b border-gray-200 dark:border-gray-600 dark:text-gray-300 text-center ${highlightChanges && editedMarks.some(mark => mark.key === row['originalIndex']) ? 'bg-yellow-500 && npmdark:text-black' : ''}`}>
                                                                {editable ? (
                                                                    <input
                                                                        type="text"
